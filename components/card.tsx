...
<feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_16_32" result="shape"/>
        ...
        <div className="col-span-2 ">
          <h2 className="font-bold text- text-black">{search_bar.mark_identification}</h2>
        ...
        <div className="col-span-1 flex flex-col justify-between">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <p className="text-black font-bold">on {new Date(registration_date * 1000).toLocaleDateString()}</p>
          </div>
          <div className="flex items-center space-x-2 mb-2">
            <p className="text-black"><svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-gray-600 font-bold">{new Date(renewal_date * 1000).toLocaleDateString()}</p>
          </div>
              ...
              <div className="space-y-1">
                {class_codes.map((code, index) => (
                  <div key={index} className="flex items-center space-x-2">
                    ...
                    <p className="text-black">Class {code}</p>
                  </div>
                ))}
              </div>
            )}
